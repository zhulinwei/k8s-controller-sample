...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RolloutSampleStatus) DeepCopyInto(out *RolloutSampleStatus) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RolloutSampleStatus.
func (in *RolloutSampleStatus) DeepCopy() *RolloutSampleStatus {
	if in == nil {
		return nil
	}
	out := new(RolloutSampleStatus)
	in.DeepCopyInto(out)
	return out
}
